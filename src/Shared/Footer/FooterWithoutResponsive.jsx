const FooterWithoutResponsive = () => {
    return (
      <footer className="footer  text-base-content p-10 bg-[#5F613A] font-familyFooter">
        <nav>
        ...
        <nav className="text-white ml-44 pl-16">
          ...
          <p className="hover:text-[#b6af61] hover:underline cursor-pointer text-xl">187,188/B, Shanta Forum, East Tower, Level 20-22, 22 Bir Uttam Mir Shawkat Sarak, Dhaka 1208</p>
  ...
  export default FooterWithoutResponsive;
